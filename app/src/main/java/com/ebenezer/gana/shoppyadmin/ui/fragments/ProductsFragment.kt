...
import com.ebenezer.gana.shoppyadmin.databinding.FragmentProductsBinding
import com.ebenezer.gana.shoppyadmin.firestore.FirestoreClass
import com.ebenezer.gana.shoppyadmin.models.Products
import com.ebenezer.gana.shoppyadmin.ui.activities.AddProductActivity
import com.ebenezer.gana.shoppyadmin.ui.adapters.MyProductsListAdapter
    ...
    private fun showAlertDialogToDeleteProduct(productID: String) {
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(resources.getString(R.string.yes)) { dialog, _ ->
                ...
                com.ebenezer.gana.shoppyadmin.firestore.FirestoreClass().deleteProduct(this, productID)
                dialog.dismiss()
            }
            .show()
